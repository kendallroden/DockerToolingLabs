...
-  [Visual Studio Code with the Docker Extension](https://code.visualstudio.com/Download)
...
9. **For the sake of not recreating the wheel, reference the following documentation, [Container Tools in Visual Studio](https://docs.microsoft.com/en-us/visualstudio/containers/?view=vs-2017), to access hands-on-labs for working with multicontainer applications, container orchestators and more.**
